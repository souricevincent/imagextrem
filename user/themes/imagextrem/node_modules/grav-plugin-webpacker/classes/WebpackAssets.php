      ...
      if ($fileExt === 'css' || $fileExt === 'js') {
        ...
        if ($mode === 'development') {
          ...
          // Trow webpacker script is not running in development mode
            ...
            throw new \RuntimeException($errorTitle . 'please check if webpacker script is actually running in development mode. (npm run webpack from your theme folder)');
          }
